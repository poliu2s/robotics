...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_hapticsSimBlk_pdInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_hapticsSimBlk_pdInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_hapticsSimBlk_pdInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_hapticsSimBlk_pd, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_hapticsSimBlk_pdInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1952404682U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1294271563U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(18682173U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4108303133U);
}
...
static const mxArray *sf_get_sim_state_info_c2_hapticsSimBlk_pd(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_hapticsSimBlk_pd\",}}"
  };
...
static void mdlSetWorkWidths_c2_hapticsSimBlk_pd(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(514572333U));
  ssSetChecksum1(S,(1781987778U));
  ssSetChecksum2(S,(4074158409U));
  ssSetChecksum3(S,(1983729702U));
