...
%   MATLAB file generated on : 23-Mar-2013 13:29:27
...
% Dependency info for S-function 'sfunc_haptics'
info(1).SFunctionName = 'sfunc_haptics';
info(1).IncPaths = {'C:\Documents and Settings\z9j7\Desktop\HDAL_SDK_2.1.3\include'};
info(1).LibPaths = {'C:\Documents and Settings\z9j7\Desktop\HDAL_SDK_2.1.3\lib'};
