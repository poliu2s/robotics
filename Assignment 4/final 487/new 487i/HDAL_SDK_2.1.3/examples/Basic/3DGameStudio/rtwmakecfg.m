...
%   MATLAB file generated on : 23-Aug-2012 14:42:59
...
info(1).IncPaths = {'C:\Program Files\Novint\HDAL_SDK_2.1.3\include'};
info(1).LibPaths = {'C:\Program Files\Novint\HDAL_SDK_2.1.3\lib'};
info(1).SourceFiles = {'main.cpp'};
